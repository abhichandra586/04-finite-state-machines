...
initial begin
    ...
    $display("--- Test 1: Send 1,0,1 --- expect out=1 ---");
    in=1; #10;
    in=0; #10;
    in=1; #10;

    $display("--- Test 2: Reset then 1,0,1 again ---");
    reset=1; #10;
    reset=0;
    in=1; #10;
    in=0; #10;
    ...
    $display("--- Test 4: Send 1,1,0,1 --- expect out=1 ---");
    reset=1; #10;
    reset=0;
    in=1; #10;
    in=1; #10;
    ...
    $display("--- Test 5: Overlapping 1,0,1,0,1 ---");
    reset=1; #10;
    reset=0;
    in=1; #10;
    in=0; #10;
